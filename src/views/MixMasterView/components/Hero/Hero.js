  ...
  return (
    <Box
      ...
      sx={{
        ...
        background: `url(${HeroImg || img?.urls?.full || HeroImg})`,
    ...
    >
      <Box
        sx={{
          ...
          width: 1,
          height: 1,
          background: alpha(secondary.dark, 0.6),
          filter: ('brightness(.5)'),
          zIndex: 1
        }}
      />
          ...
          <Box marginBottom={4}>
            <Typography variant="h3" sx={{fontWeight: 900, color: 'common.white'}} gutterBottom>
              <Typography variant={'cursive'} color={'rgba(225 225 225/ .8)!important'} component={'div'}>
                Introducing "MixMaster"
              </Typography>The ultimate cocktail companion app!</Typography>
          ...
          <Box padding={{xs: 3, sm: 6}} width={1} component={Card} boxShadow={1}>
            ...
            <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
              <Typography component="p" variant="body2" align="left">
                Discover, mix, and sip your way to cocktail bliss with MixMaster today
                Trending:
              </Typography>
